...
export default function BonelessPage(props) {
  ...
  return (
    ...
    <Box className='tsFlex'>
      ...
      <Button onClick={() => props.Add(props.item)} sx={{ backgroundColor: '#E4002B', color: 'white', fontSize: 'calc(1rem + 0.4vw)',padding:'0.5em'}} color="success"> Add To Bucket </Button>
    </Box>
  </div>
  );
}
