    ...
    <div>
      ...
      <div className='cb' style={{ color: 'white', height: '450px', marginTop: '200px' }}>
        <div className='zzz'>
          ...
          <img style={{ position: 'absolute', top: '250px', left: '250px', height: '390px' }} src="https://images.kfcpakistan.com/image/1670410817354-image.jpg" alt="" />
        </div>

        <div style={{ marginTop: '60px',justifyContent: 'space-between',alignItems: 'center' }}>
          <h1 style={{ fontWeight: 'bold', lineHeight: '1.167' }}>Family Festival 1</h1>
          <h5 style={{}}>It includes 4 Krunch burgers+ 4 pieces Hot and Crispy Chicken + 1.5 Ltr drink</h5>
          <h2 style={{ fontWeight: 'bold' }}>Rs 1790</h2>
