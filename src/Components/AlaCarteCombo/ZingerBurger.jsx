...
export default function ZingerBurger(props) {
  const { items15, Add } = props
  ...
  return (
    ...
    <Box>
      ...
      {items15.map((x) => {
        ...
        return (
          <>
            <Box style={{ color: 'white', fontSize: 'calc(1rem + 1.2vw)', textAlign: 'center', marginTop: '2em', fontWeight: 'bold' }}>Ala Carte Combo</Box>
